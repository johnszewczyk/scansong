...
public enum BuiltInScannerPlugins {
    public static let registry = ScannerPluginRegistry(descriptors: [
        ...
        .init(pluginID: "standard-audio", displayName: "Core Audio", supportedExtensions: ["aif", "aiff", "flac", "m4a", "mp3", "ogg", "wav"], structurePolicy: .knownSingle, metadataPolicy: .optionalDeferred, priority: 10),
        ...
        .init(pluginID: "vgmstream", displayName: "vgmstream", supportedExtensions: ["aa3", "adx", "ads", "aifc", "at3", "aus", "bnk", "dvi", "fsb", "genh", "int", "mib", "msf", "mtaf", "rws", "ss2", "stream", "svag", "vag", "xa"], structurePolicy: .enumerate, metadataPolicy: .decoder, priority: 10),
