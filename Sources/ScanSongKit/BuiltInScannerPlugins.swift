...
public enum BuiltInScannerPlugins {
    ...
    public static let directVGMStreamExtensions =
        VGMStreamFormatManifest.directScannerExtensions.subtracting(["adx", "xa"])
    ...
    public static let registry = ScannerPluginRegistry(descriptors: [
        ...
        .init(pluginID: "vgmstream", displayName: "vgmstream", supportedExtensions: directVGMStreamExtensions.union(["adx", "xa"]), structurePolicy: .enumerate, metadataPolicy: .decoder, priority: 10),
