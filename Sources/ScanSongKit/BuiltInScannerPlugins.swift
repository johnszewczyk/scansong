...
public enum BuiltInScannerPlugins {
    ...
    public static let directVGMStreamExtensions =
        VGMStreamFormatManifest.directScannerExtensions.subtracting(["adx"])
    ...
    public static let registry = ScannerPluginRegistry(descriptors: [
        ...
        .init(pluginID: "vgmstream", displayName: "vgmstream", supportedExtensions: directVGMStreamExtensions.union(["adx"]), structurePolicy: .enumerate, metadataPolicy: .decoder, priority: 10),
