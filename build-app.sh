...
[[ -x "$VGMSTREAM_CLI_SOURCE" ]] || { echo "Missing MediaScanner vgmstream plugin: $VGMSTREAM_CLI_SOURCE" >&2; exit 1; }
...
[[ -x "$HIGHLY_COMPLETE_INSPECT_SOURCE" ]] || { echo "Missing MediaScanner Highly Complete plugin: $HIGHLY_COMPLETE_INSPECT_SOURCE" >&2; exit 1; }
